...
public abstract class BasicLocalServiceActivity<T extends Enum<T>, U extends BasicLocalService<U>> extends BasicActivity<T> implements BasicLocalServiceUser<U>
{
    private static final String TAG = "PLB-BaseLocServeAct";

    private AtomicBoolean isBound;
    private BasicLocalServiceConnector<T, U> connector;
    private U service;

    protected abstract BasicLocalServiceConnector<T, U> getConnector(BasicLocalServiceActivity<T, U> activity);

    public BasicLocalServiceActivity()
    {
        super();
